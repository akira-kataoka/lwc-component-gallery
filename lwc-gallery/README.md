...
- **フォーム**: 入力フィールド / トグルスイッチ / セレクト / チェックボックス / テキストエリア / ラジオボタン / 検索ボックス / スライダー / 数値ステッパー / ファイルアップロード / カラースウォッチ / 日付フィールド / タグ入力 / 選択チップ / インライン編集 / OTP入力 / 通貨入力 / 電話番号入力 / リッカート尺度 / パスワード入力 / コンボボックス / ピル複数選択
- **フィードバック**: アラート / スピナー / トースト通知 / 空状態 / 円形プログレス / スケルトン / バナー / セグメント進捗 / コールアウト / ローディングドット
- **ダッシュボード**: 指標カード / ドーナツチャート / アクティビティフィード / 目標プログレス
- **レコード**（Recordページ向け・SF実データ連携）: レコードカード（getRecord） / レコード表示（record-view-form） / レコード編集（record-edit-form） / レコードパス
