...
- **表示**: バッジ / データテーブル / プログレスバー / アバター / ピル / スター評価 / KPI表示 / タイムライン / ステータスドット / リスト / メーター / カウントバッジ / タグ / キーボードキー / リボン / カレンダー / カルーセル / アバターグループ / コードブロック / スパークライン / 棒グラフ / 評価サマリー / 定義リスト / ゲージ / トレンドバッジ / サーモメーター / 開閉テキスト / タグクラウド / カウントアップ
...
- **フォーム**: 入力フィールド / トグルスイッチ / セレクト / チェックボックス / テキストエリア / ラジオボタン / 検索ボックス / スライダー / 数値ステッパー / ファイルアップロード / カラースウォッチ / 日付フィールド / タグ入力 / 選択チップ / インライン編集 / OTP入力 / 通貨入力 / 電話番号入力 / リッカート尺度 / パスワード入力 / コンボボックス / ピル複数選択 / タイル選択
- **フィードバック**: アラート / スピナー / トースト通知 / 空状態 / 円形プログレス / スケルトン / バナー / セグメント進捗 / コールアウト / ローディングドット / スナックバー
