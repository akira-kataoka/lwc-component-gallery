...
- **表示**: バッジ / データテーブル / プログレスバー / アバター / ピル / スター評価 / KPI表示 / タイムライン / ステータスドット / リスト / メーター / カウントバッジ / タグ / キーボードキー / リボン / カレンダー / カルーセル
- **アクション**: ボタン / ボタングループ / アイコンボタン / コピーボタン / 分割ボタン
- **レイアウト**: カード / アコーディオン / 区切り線
- **オーバーレイ**: モーダル / ツールチップ / ポップオーバー
- **ナビゲーション**: タブ / ページネーション / パンくずリスト / ステップ / ドロップダウンメニュー / 縦ナビ / ツリー
- **フォーム**: 入力フィールド / トグルスイッチ / セレクト / チェックボックス / テキストエリア / ラジオボタン / 検索ボックス / スライダー / 数値ステッパー / ファイルアップロード / カラースウォッチ / 日付フィールド
