...
- **表示**: バッジ / データテーブル / プログレスバー / アバター / ピル / スター評価 / KPI表示 / タイムライン / ステータスドット / リスト / メーター / カウントバッジ / タグ / キーボードキー / リボン / カレンダー / カルーセル / アバターグループ / コードブロック / スパークライン / 棒グラフ / 評価サマリー / 定義リスト / ゲージ / トレンドバッジ / サーモメーター / 開閉テキスト / タグクラウド
- **アクション**: ボタン / ボタングループ / アイコンボタン / コピーボタン / 分割ボタン / フローティングボタン / トグルボタン
- **レイアウト**: カード / アコーディオン / 区切り線 / ツールバー / メディアオブジェクト / グリッド
- **オーバーレイ**: モーダル / ツールチップ / ポップオーバー / ドロワー / 確認ダイアログ
- **ナビゲーション**: タブ / ページネーション / パンくずリスト / ステップ / ドロップダウンメニュー / 縦ナビ / ツリー / 縦ステップ / ドットページャー
...
- **フィードバック**: アラート / スピナー / トースト通知 / 空状態 / 円形プログレス / スケルトン / バナー / セグメント進捗 / コールアウト / ローディングドット
